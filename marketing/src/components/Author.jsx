        ...
        <div className="pt-px bg-slate-50 sm:rounded-6xl">
          ...
          <div className="px-4 py-10 sm:px-10 sm:py-16 md:py-20 lg:px-20 lg:py-32">
            ...
            <p className="mt-8 text-5xl font-extrabold tracking-tight font-display text-slate-900 sm:text-6xl">
              <span className="block text-blue-600">Our Company –</span> We are a team of experienced architects and designers.
            </p>
            ...
            <p className="mt-8">
              ...
              >
                ...
                <span className="ml-4">Connect with us on Twitter</span>
              </Link>
            </p>
          </div>
        </div>
